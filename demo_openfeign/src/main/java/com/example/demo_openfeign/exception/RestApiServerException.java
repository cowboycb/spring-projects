...
public class RestApiServerException extends Exception {
    ...
    public RestApiServerException(String requestUrl, HttpStatus responseStatus,
                                  Response.Body responseBody) {
        super("A Server exception was thrown from " + requestUrl);
        this.content = getContent(responseBody);
        this.httpStatus = responseStatus;
        log.error("Server exception handled {}, {}", requestUrl, content);
    }
